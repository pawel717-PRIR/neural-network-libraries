...
train_loader = torch.utils.data.DataLoader(
    torchvision.datasets.CIFAR100('CIFAR100_data/', train=True, download=True,
                               transform=torchvision.transforms.ToTensor()),
    batch_size=batch_size_train, shuffle=True)

test_loader = torch.utils.data.DataLoader(
    torchvision.datasets.CIFAR100('CIFAR100_data/', train=False, download=True,
                               transform=torchvision.transforms.ToTensor()),
...
optimizer = optim.SGD(network.parameters(), lr=learning_rate, momentum=0.9, nesterov=True)
train_counter = []
